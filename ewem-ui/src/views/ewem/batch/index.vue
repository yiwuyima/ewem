<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="batchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="批号" align="center" prop="number"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="批次号" prop="number">
          <el-input v-model="form.number" placeholder="请输入批号" :disabled="numberDisabled"/>
        </el-form-item>
        <el-form-item label="产品" prop="productId">
...
<script>
  import { listBatch, getBatch, delBatch, addBatch, updateBatch, exportBatch } from '@/api/ewem/batch'
  import { listProduct } from '@/api/ewem/product'
